...
export default function RooftopShowcase() {
  ...
  return (
    <section id="rooftop" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="glass-card-studio rounded-[38px] overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-center">
          {/* Content Left */}
          <div className="lg:col-span-6 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
            <span className="font-script text-3xl text-neutral-500 mb-2">
              The Harrington Road Vibe
            </span>
            <h2 className="font-display text-4xl sm:text-6xl uppercase tracking-wider leading-tight mb-6 text-neutral-950">
              ...
              {features.map((f, i) => {
                ...
                return (
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-black uppercase tracking-wider text-neutral-950">
                        {f.title}
                      </h4>
            ...
            <div>
              <motion.button
                ...
                className="inline-flex items-center gap-3 bg-neutral-950 hover:bg-neutral-800 text-white font-extrabold text-sm uppercase tracking-wider px-8 py-4 rounded-full shadow-xl transition-all"
              >
          ...
          {/* Media Right */}
          <div className="lg:col-span-6 h-full min-h-[480px] relative overflow-hidden">
            <img
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-espresso-950/80 via-transparent to-transparent lg:hidden" />
          </div>
        </div>
      </div>
    </section>
